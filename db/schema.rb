...
ActiveRecord::Schema.define(version: 20140707203324) do
  ...
  create_table "comments", force: true do |t|
    ...
    t.integer  "tib_term_id", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  add_index "comments", ["tib_term_id"], name: "index_comments_on_tib_term_id", using: :btree
